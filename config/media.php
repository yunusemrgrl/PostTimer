...
return [
     ...
     *
     * Thumbnail üretimi client-side'dır (tarayıcıda canvas ile ilk frame
     * yakalanıp POST /media/{id}/thumbnail endpoint'ine gönderilir) —
     * server-side FFmpeg bağımlılığı yoktur.
     */
